...
function Chat(props) {
  ...
  const socket = user && io(url, { transports: ["websocket"] });
      ...
      <div className="page-breadcrumb">
        <div className="row">
          <div className="col-7 align-self-center">
            <h4 className="page-title text-truncate text-dark font-weight-medium mb-0">
              Chat
            </h4>
          </div>
        </div>
                        ...
                        <div className="message-center">
                          {isLogin &&
                            ...
                            allRoom.map((value) => (
                              <button
                                key={value._id}
                                onClick={() => handleRoomChange(value.session)}
                                className="message-item d-flex align-items-center border-bottom px-3 py-2 active_user button_user"
                              >
